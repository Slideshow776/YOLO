...
class FiftyToSeventy(x: Float, y: Float, s: Stage) : BaseActor(x, y, s) {
    private var tag = "FiftyToSeventy"
    ...
    init {
        ...
        for (i in 0 until 15)
            animationImages.add(BaseGame.textureAtlas!!.findRegion("character/50-70/head"))
        animationImages.add(BaseGame.textureAtlas!!.findRegion("character/50-70/head-blink"))
        head = BaseActor(0f, 0f, s)
        head.setAnimation(Animation(.5f, animationImages, Animation.PlayMode.LOOP))
        head.setSize(34f, 18.2f)
        head.setPosition(x - 16.4f, y - 0.15f)
        ...
        body.loadImage("character/50-70/body")
        body.setSize(25f, 25.86f)
        body.setPosition(x - 12f, y - 25f)

        leftArm = BaseActor(0f, 0f, s)
        leftArm.loadImage("character/50-70/leftArm")
        leftArm.setSize(10f, 12f)
        leftArm.setPosition(x + 7.8f, y - 11.2f)
        ...
        rightArm.loadImage("character/50-70/rightArm")
        rightArm.setSize(10f, 12f)
        rightArm.setPosition(x - 16.4f, y - 11.2f)
